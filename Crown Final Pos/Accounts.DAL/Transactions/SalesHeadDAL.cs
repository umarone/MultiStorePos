...
namespace Accounts.DAL
{
    public class SalesHeadDAL
    {
        ...
        public EntityoperationInfo InsertSalesReturn(VouchersEL oelVoucher, List<VoucherDetailEL> oelSaleCollection, List<VoucherDetailEL> oelSalesReturnTransactionsCollection, List<VoucherDetailEL> oelProductsProfitLossCollection, SqlConnection objConn)
        {
            EntityoperationInfo info = new EntityoperationInfo();
            lock (this)
            {
                ...
                try
                {
                    ...
                    dal.InsertProductsProfitLoss(oelProductsProfitLossCollection, Identity, objConn, objTran);
