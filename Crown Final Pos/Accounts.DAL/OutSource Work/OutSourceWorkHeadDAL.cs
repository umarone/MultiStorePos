...
namespace Accounts.DAL
{
    public class OutSourceWorkHeadDAL
    {
       ...
       public Int64 GetMaxPurchaseNumber(Int64 IdCompany, bool IsNetPurchases, SqlConnection objConn)
       {
           using (SqlCommand cmdPurchases = new SqlCommand("[Transactions].[Proc_GetMaxPurchaseNumber]", objConn))
           {
               ...
               cmdPurchases.Parameters.Add("@IdCompany", SqlDbType.BigInt).Value = IdCompany;
