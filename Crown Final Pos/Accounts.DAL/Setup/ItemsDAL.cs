...
namespace Accounts.DAL
{
    public class ItemsDAL
    {
        ...
        public List<ItemsEL> GetItemsCurrentStockByBarCode(string BarCode, Int64 IdProject, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItem = new SqlCommand("[Setup].[Proc_GetItemsCurrentStockByBarCode]", objConn);
