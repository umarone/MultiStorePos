...
namespace Accounts.BLL
{
    public class TransactionBLL
    {
        ...
        public List<TransactionsEL> GetItemsProfitLossStatementByDate(Int64 IdProject, DateTime StartDate, DateTime EndDate)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetItemsProfitLossStatementByDate(IdProject, StartDate, EndDate, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
