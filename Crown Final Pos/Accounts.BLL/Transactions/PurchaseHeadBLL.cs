...
namespace Accounts.BLL
{
    public class PurchaseHeadBLL
    {
        ...
        public Int64 GetMaxPurchaseNumber(Int64 IdProject, Int64 BookNo)
        {
            ...
            {
                objConn.Open();
                return dal.GetMaxPurchaseNumber(IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public Int64 GetMaxPurchaseReturnNumber(Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            EntityoperationInfo infoResult = new EntityoperationInfo();
            try
            {
                objConn.Open();
                return dal.GetMaxPurchaseReturnNumber(IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<VoucherDetailEL> GetPOSPurchasesReturnTransactions(Int64 IdVoucher, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            EntityoperationInfo infoResult = new EntityoperationInfo();
            try
            {
                objConn.Open();
                return dal.GetPOSPurchasesReturnTransactions(IdVoucher, IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<VoucherDetailEL> GetPOSPurchasesReturnTransactionsByNumber(Int64 VoucherNo, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            EntityoperationInfo infoResult = new EntityoperationInfo();
            try
            {
                objConn.Open();
                return dal.GetPOSPurchasesReturnTransactionsByNumber(VoucherNo, IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
