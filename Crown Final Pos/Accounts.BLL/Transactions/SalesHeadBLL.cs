...
namespace Accounts.BLL
{
    public class SalesHeadBLL
    {
        ...
        public EntityoperationInfo InsertSalesReturn(VouchersEL oelVoucher, List<VoucherDetailEL> oelSaleCollection, List<VoucherDetailEL> oelTransactionsCollection, List<VoucherDetailEL> oelProductsProfitLossCollection)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                ...
                return dal.InsertSalesReturn(oelVoucher, oelSaleCollection, oelTransactionsCollection, oelProductsProfitLossCollection, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
