...
namespace Accounts.UI
{
    public partial class frmPartyWiseSaleSummary : MetroForm
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            List<SaleDetailEL> list = manager.GetPartyWiseSaleSummaryForDistribution(Operations.IdProject, Operations.BookNo, EmpAccountNo, EmpDeliveryAccountNo, dtStart.Value, dtEnd.Value);
            if (list.Count > 0)
            {
