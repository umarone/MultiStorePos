...
namespace Accounts.UI
{
    public partial class frmPosInvoice : Form
    {
        ...
        frmFindVouchers frmfindallvouchers;
        //frmFindProductsOnForm frmFindOnlineProducts;
        frmFindProductsOnForm frmFindOnlineProducts;
        ...
        int StandarCount = 0, EventCallCounter = 0;
        #endregion
        ...
        private void grdProducts_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == 6) //Rate column
            {
                grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value = Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colQuantity"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colUnitPrice"].Value);
            ...
            else if (e.ColumnIndex == 8)
            {
                if (grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value != null)
                {
                    ...
                    grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value = CellValue + "%"; //Validation.GetSafeString(grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value) + "%";
                }
                else
                {
                    grdProducts.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value);
        ...
        private void grdProducts_CellClick(object sender, DataGridViewCellEventArgs e)
        {
                    ...
                    if (CurrentRowQuantity >= 1)
                    {
                        ...
                        if (CurrentRowQuantity > 0)
                        {
                            ...
                            if (Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colDiscInPercentage"].Value) == 0)
                            {
                                ...
                                grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value = 0;
                                //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colNetAmount"].Value = grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value; //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value;
                                grdProducts.Rows[e.RowIndex].Cells["colNetAmount"].Value = grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value; //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value;
                            }
                            else
                            {
                                ...
                                grdProducts.Rows[e.RowIndex].Cells["colNetAmount"].Value = (Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value)) - ((Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colDiscInPercentage"].Value)) / 100);
                            }
                        }
                    }
                }
                ...
                if (e.RowIndex > -1)
                {
                    ...
                    if (CurrentRowQuantity >= 1)
                    {
                        ...
                        if (Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colDiscInPercentage"].Value) == 0)
                        {
                            ...
                            grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value = 0;
                            //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colNetAmount"].Value = grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value; //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value;
                            grdProducts.Rows[e.RowIndex].Cells["colNetAmount"].Value = grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value;
                        }
                        else
                        {
                            //grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colNetAmount"].Value = (Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value)) - ((Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value)) / 100); //(Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value)) - ((Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colDiscInPercentage"].Value)) / 100);
                            grdProducts.Rows[e.RowIndex].Cells["colNetAmount"].Value = (Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value)) - ((Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colAmount"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[e.RowIndex].Cells["colDiscInPercentage"].Value)) / 100); //(Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value)) - ((Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colAmount"].Value) * Validation.GetSafeDecimal(grdProducts.Rows[grdProducts.Rows.Count - 1].Cells["colDiscInPercentage"].Value)) / 100);
                        }
                    }
                }
            ...
            else if (e.ColumnIndex == 12)
            {
                ...
                {
                    DataGridViewRow ORow = grdProducts.Rows[e.RowIndex];
                    if (Validation.GetSafeLong(grdProducts.Rows[e.RowIndex].Cells["ColIdVoucherDetail"].Value) > 0)
                    {
                        //Delete from Database...
                        var manager = new SalesDetailBLL();
                        if (manager.DeleteSalesDetails(Validation.GetSafeLong(grdProducts.Rows[e.RowIndex].Cells["ColIdVoucherDetail"].Value)))
                        {
        ...
        private bool ValidateControls()
        {
            ...
            if (IdVoucher.HasValue && IdVoucher.Value > 0)
            {
                ...
                {
                    if (CustomerTransactionId != null && CustomerTransactionId > 0)
                    {
                ...
                else if (cbxCustomerType.SelectedIndex == 1)
                {
                    //if (IsWhatTransactionType)
                    //{
                    if (CashTransactionId != null && CashTransactionId > 0)
                    {
                    ...
                    if (ValidateBookPeriod())
                    {
                        ...
                        if (IdVoucher == null || IdVoucher == 0)
                        {
                            for (int k = 0; k < grdProducts.Rows.Count; k++)
                            {
                                ...
                                oelProductsProfitLoss.NetSaleAmount = Validation.GetSafeDecimal(grdProducts.Rows[k].Cells["colNetAmount"].Value);
                                ...
                                oelProductsProfitLoss.AccountType = "Add";
                            ...
                            if (MessageBox.Show("Save It ?", "Saving Sale", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
                            {
                                ...
                                if (infoResult.IsSuccess)
                                {
                                    ...
                                    if (!chkNoPrint.Checked)
                                    {
                                        ...
                                        PrintCrystalReport(IdVoucher.Value);
                                    }
                                    FillData();
        ...
        private void toolStripBtnRecentInvoices_Click(object sender, EventArgs e)
        {
            frmfindallvouchers = new frmFindVouchers();
            frmfindallvouchers.VoucherType = VoucherTypes.SaleInvoiceVoucher.ToString();
            frmfindallvouchers.ExecuteFindVouchersEvent += new frmFindVouchers.VouchersDelegate(frmfindallvouchers_ExecuteFindVouchersEvent);
            frmfindallvouchers.ShowDialog();
        }
        ...
        private void PrintCrystalReport(Int64 IdVoucher)
        {
            //LocalReport rptInvoice = new LocalReport();
            //var Manager = new SalesHeadBLL();
            //ReportDataSource reportRDS = new ReportDataSource("dtReport", Manager.GetRdlcSalesTransactions(IdVoucher, Operations.IdProject, Operations.BookNo, CustEditBox.Visible ? false : true).Tables[0]);
        ...
        void frmfindallvouchers_ExecuteFindVouchersEvent(VouchersEL oelVoucher)
        {
            PosInvoiceNumber = oelVoucher.VoucherNo;
            txtInvoiceNumber.Text = Validation.GetSafeString(oelVoucher.VoucherNo);
            FillPosInvoiceByNumber();
        }
        #endregion
        ...
        private void txtInvoiceNumber_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                PosInvoiceNumber = Validation.GetSafeLong(txtInvoiceNumber.Text);
                FillPosInvoiceByNumber();
            }
        }
        private void cbxProducts_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar != (char)Keys.Enter && e.KeyChar != (char)Keys.Escape)
            {
                ...
                {
                    e.Handled = true;
                    frmFindOnlineProducts = new frmFindProductsOnForm();
                    frmFindOnlineProducts.SearchText = e.KeyChar.ToString();
                    frmFindOnlineProducts.ExecuteFindPorudctsEvent += FrmFindOnlineProducts_ExecuteFindPorudctsEvent;
                    frmFindOnlineProducts.Location = new Point(cbxProducts.PointToScreen(Point.Empty).X, cbxProducts.PointToScreen(Point.Empty).Y + cbxProducts.Height);                   
                    frmFindOnlineProducts.ShowDialog(this);                    
                    EventCallCounter = 1;
                }
            }
        }

        private void FrmFindOnlineProducts_ExecuteFindPorudctsEvent(object Sender, ItemsEL oelItems)
        {
            GetItemById(oelItems.IdItem);
            EventCallCounter = 0;
        }
        ...
        private void GetItemByBarCode(string BarCode)
        {
            if (!string.IsNullOrEmpty(BarCode))
            {
                ...
                {
                    //MessageBox.Show(cbxProducts.Text);
                    decimal Quantity = manager.GetItemClosingStock(list[0].IdItem.Value);
                    if (Quantity > 0)
                    {
        ...
        private void FillPosInvoiceByNumber()
        {
            ...
            List<VoucherDetailEL> ListSales = Manager.GetPosSalesTransactionsByNumber(PosInvoiceNumber.Value, Operations.IdProject, Operations.BookNo);
            if (ListSales.Count > 0)
            {
                ...
                List<VoucherDetailEL> listTransactions = Manager.GetSalesSubTransactions(IdVoucher.Value, Operations.IdProject, Operations.BookNo, ListSales[0].IsNetTransaction.Value);
