    ...
    public partial class frmPosPurchases : Form
    {
        ...
        private bool ValidateControls()
        {
            ...
            if (IdVoucher.HasValue && IdVoucher.Value > 0)
            {
                ...
                {
                    if (SupplierTransactionId != null && SupplierTransactionId > 0)
                    {
                ...
                else if (cbxPurchasesType.SelectedIndex == 1)
                {
        ...
        private void toolStripBtnMyBills_Click(object sender, EventArgs e)
        {
            frmfindVouchers = new frmFindVouchers();
            frmfindVouchers.VoucherType = VoucherTypes.StockReceiptVoucher.ToString();
            frmfindVouchers.IsNetTransaction = true;
