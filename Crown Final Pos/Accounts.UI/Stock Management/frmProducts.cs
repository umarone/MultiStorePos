...
namespace Accounts.UI
{
    public partial class frmProducts : MetroForm
    {
        ...
        private bool ValidateControls()
        {
            ...
            //    isValid = false;
            //}
            else if (txtMRP.Text == string.Empty)
            {
                MessageBox.Show("Sale Price Is Must....");
                isValid = false;
            }
            ...
            {
                MessageBox.Show("No Barcode Standard Is Followed, please enter atleast 13 digits for Barcode....");
                isValid = false;
            }
            return isValid;
        }
