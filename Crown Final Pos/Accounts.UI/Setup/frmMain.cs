...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        frmItemsProfitLossStatement frmitemwiseprofitloss;
        frmTotalItemsSales frmtotalitemssalesummar;
        frmPosBarCodePrinting frmlabelledprinting;
        ...
        private void rbnBtnBarcodePrinting_Click(object sender, EventArgs e)
        {
            frmlabelledprinting = new frmPosBarCodePrinting();
            frmlabelledprinting.MdiParent = this;
            frmlabelledprinting.Show();
        }
        ...
        private void rbnBtnProductsProfitLoss_Click(object sender, EventArgs e)
        {
            frmitemwiseprofitloss = new frmItemsProfitLossStatement();
            frmitemwiseprofitloss.MdiParent = this;
            frmitemwiseprofitloss.Show();
        }
        private void rbnBtnProductsTotalSale_Click(object sender, EventArgs e)
        {
            frmtotalitemssalesummar = new frmTotalItemsSales();
            frmtotalitemssalesummar.MdiParent = this;
            frmtotalitemssalesummar.Show();
        }
        #endregion
